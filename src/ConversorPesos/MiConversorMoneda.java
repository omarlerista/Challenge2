...
public class MiConversorMoneda {
	...
	public void ConvertirPesosMxMDolar(double valor) {
		double monedaDolar = valor / 17.18;
		monedaDolar = (double)Math.round(monedaDolar * 100d) /100 ;
		JOptionPane.showMessageDialog(null, "Tienes $ " + monedaDolar + " Dolares");
	}

	public void ConvertirPesosMxMEuros(double valor) {
		double monedaEuro = valor / 18.54;
		monedaEuro = (double)Math.round(monedaEuro * 100d) /100 ;
		JOptionPane.showMessageDialog(null, "Tienes $ " + monedaEuro + " Euros");
	}
	
	public void ConvertirPesosMxMLibra(double valor) {
		double monedaLibra = valor / 21.68;
		monedaLibra = (double)Math.round(monedaLibra * 100d) /100 ;
		JOptionPane.showMessageDialog(null, "Tienes $ " + monedaLibra + " Libras Esterlinas");
	}
	public void ConvertirPesosMxMYen(double valor) {
		double monedaYen = valor / 0.12;
		monedaYen = (double)Math.round(monedaYen * 100d) /100 ;
		JOptionPane.showMessageDialog(null, "Tienes $ " + monedaYen + " Yen Japonés");
	}
	public void ConvertirPesosMxMWon(double valor) {
	...
	public void ConvertirDolaresPesosArgentino(double valor) {
		double monedaDolar = 17.18 * valor;
		monedaDolar = (double)Math.round(monedaDolar * 100d) /100 ;
